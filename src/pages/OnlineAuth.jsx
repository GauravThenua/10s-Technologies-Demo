...
export default function OnlineAuth() {
  const links = [
    { to: "/advanced/online-auth/register", label: "End User Registration" },
    { to: "/advanced/online-auth/auth-id", label: "User ID Card" },
    { to: "/advanced/online-auth/rp1", label: "User Transaction - RP1" },
    { to: "/advanced/online-auth/rp2", label: "User Transaction - RP2" },
    { to: "/advanced/online-auth/admin", label: "IDP Admin Portal" },
    { to: "/advanced/online-auth/DBsearch", label: "IDP DB Search" },
    { to: "/advanced/online-auth/mitm", label: "Bad Guy Scenario – MITM" },
  ];
