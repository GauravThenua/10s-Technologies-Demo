...
const AdvanceRP2 = () => {
  ...
  (u) =>
    ...
    toast.success("Please Reach Out To IDP For Complete ID", { position: "top-center" });
    setSubmitted(true);
  ...
  return (
    <div className="p-8 max-w-md mx-auto relative">
      <h2 className="text-xl font-bold mb-4">
        Relying Party 2 - Online Store 2
      </h2>
      ...
      {!submitted ? (
        <>
          ...
          {/* ID field with Paste Icon on Right */}
